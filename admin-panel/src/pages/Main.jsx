...
function Main() {
  ...
  useEffect(() => {
    switch (selectedKeys) {
      case '1': {
        window.document.title = 'EDM hostel — Dashboard';
        break;
      }
      case '2': {
        window.document.title = 'EDM hostel — Users';
        break;
      }
      case '3': {
        window.document.title = 'EDM hostel — Hotel Rooms';
        break;
      }
      case '4': {
