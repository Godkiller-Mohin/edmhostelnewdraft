      ...
      <Skeleton loading={loading} paragraph={{ rows: 10 }} active avatar>
        {error ? (
          ...
          >
            ...
            <Descriptions.Item
              label={<span className='whitespace-nowrap'>Event Name</span>}
            >
            ...
            <Descriptions.Item
              label={<span className='whitespace-nowrap'>Event Last Update At</span>}
            >
              {response?.data?.updated_at?.split('T')[0]}
            </Descriptions.Item>
            <Descriptions.Item
              label={<span className='whitespace-nowrap'>Event Created At</span>}
              span={2}
            >
