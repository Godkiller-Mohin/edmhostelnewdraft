...
import bar1Image from "../assets/our-gallery-03.jpeg";
import partyImage from "../assets/bar1.jpg";
import rechargeImage from "../assets/our-gallery-02.jpeg";
import viewImage from "../assets/intro-views.jpeg";
    ...
    <div className="bg-[#032a25] text-[#e0d7c7] font-sans pt-40 min-h-screen">
      <div className="max-w-7xl mx-auto p-5 grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="relative inline-block mb-12 group">
                ...
                <h2 className="text-5xl md:text-5xl sm:text-2xl mb-3">
                  {" "}
                  {/* Increased margin bottom */}
                  {section.title}
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                ...
                <div className="perspective-1000 md:order-2 order-1 group">
                  <div
                    className="relative overflow-hidden rounded-xl transform-gpu transition-all duration-500 
                  ...
                  >
                    ...
                    />
                    <div
                      className="absolute inset-0 border-2 border-[#e0d7c7]/0 group-hover:border-[#e0d7c7]/20 
        ...
        <div className="relative lg:order-2 order-1">
          <div
            className="lg:sticky lg:top-20 bg-[#032221] p-8 rounded-xl shadow-lg
          ...
          >
            ...
            {/* Increased margin */}
            <div className="w-12 h-0.5 bg-[#e0d7c7] mx-auto mb-10 transition-all duration-300 hover:w-24"></div>{" "}
            {/* Increased margin */}
            <div className="mb-10">
              {" "}
              {/* Increased margin */}
            ...
            <div className="flex flex-col sm:flex-col gap-6 mt-10">
              {" "}
              {/* Increased gap */}
              <button
